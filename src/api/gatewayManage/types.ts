...
export interface GatewayMainResponse {
  gateway_id: number;
  gateway_name: string;
  gateway_model: number;
...
export interface GatewayAcquisitionResponse {
  channel_id: number;
  channel_name: string;
  protocol_id: number;
...
export interface GatewayForwardResponse {
  channel_id: number;
  channel_name: string;
  protocol_id: number;
...
export interface channelDeviceQuery {
  channel_type: number;
  channel_id: number;
  page_size: number;
  page: number;
...
export interface channelDeviceResponse {
  port_type: number;
  devices: {
    dev_id: number;
    dev_name: string;
...
export interface CreateOrEditGatewayQuery {
  gateway_name: string;
  gateway_model?: number;
  sync_way?: number;
  primary_ip: string;
...
export interface SyncGatewayQuery {
  gateway_id: number;
  is_rebuild: boolean;
}

export interface EnableAcquisitionsOrForwards {
  channel_id: number;
  enabled: boolean;
}
