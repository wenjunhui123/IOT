...
import {
  editAcquisitionBasic,
  getProtocolList,
  queryAcquisitionBasic,
...
async function getCurrentInfo() {
  ...
  if (res.code === 0) {
    ...
    model.value = data;
    model.value.baud_rate = data?.serial_params?.baud_rate || null;
    model.value.data_bit = data?.serial_params?.data_bit || null;
    model.value.parity_bit = data?.serial_params?.parity_bit || null;
    model.value.stop_bit = data?.serial_params?.stop_bit || null;
  }
}
